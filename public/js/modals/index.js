...
export const modalOperations = async data => {
    ...
    try{
        const res = await axios.post(`http://63.250.33.235:3999/add_restaurant_comment`,{
            ...op,
            headers: {
...
export const propertyOperations = async data => {
    ...
    try{
        const res = await axios.post(`http://63.250.33.235:3999/add_property_comment`,{
            ...op,
            headers: {
                'Content-Type': 'application/json'
            }
...
export const kitchenOperations = async data => {
    ...
    try{
        const res = await axios.post(`http://63.250.33.235:3999/add_kitchen_comment`,{
            ...op,
            headers: {
                'Content-Type': 'application/json'
            }
...
export const businessOperations = async data => {
    ...
    try{
        const res = await axios.post(`http://63.250.33.235:3999/add_business_comment`,{
            ...op,
            headers: {
                'Content-Type': 'application/json'
            }
...
export const solutionsOperations = async data => {
    ...
    try{
        const res = await axios.post(`http://63.250.33.235:3999/add_solutions_comment`,{
            ...op,
            headers: {
                'Content-Type': 'application/json'
            }
